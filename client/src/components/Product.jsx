// Product Card - Reusable product display component with hover effects and navigation
...
const Product = ({product}) => {
  ...
  // UI state for interactive effects
  ...
  return (
    <div className="p-4 lg:w-1/4 md:w-1/2 w-full" onClick={handleClick}>
      {/* Product card with hover animations and click handler */}
      <div 
      ...
      >
        {/* Product image container with loading skeleton */}
