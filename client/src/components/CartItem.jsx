// Cart Item - Individual cart item with quantity controls and remove functionality
...
const CartItem = ({ item }) => {
    ...
    // Remove item completely from cart (server + Redux)
    const handleRemoveFromCart = async () => {
        try {
            ...
            if (data.success) {
                dispatch(removeFromCart(item.id)) // Update Redux state
