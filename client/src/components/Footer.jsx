...
// Footer Component - Site footer with navigation links and company information
  ...
  return (
    <footer className="pt-10 border-t py-6 mt-20">
      ...
      <div className="container mx-auto px-5 grid md:grid-cols-4 sm:grid-cols-2 gap-8 text-sm">
        {/* About section with main navigation links */}
        <div>
        ...
        <div>
          ...
          <p>Developed By <a href="" className="underline text-blue-400" target="_blank">Yogesh Nade</a></p>
